...
- **섭씨/화씨 전환**: 온도 클릭으로 단위 전환 (v1.4.0)
  - 부드러운 회전 애니메이션 (80px 슬라이드)
  - 위에서 아래로 자연스러운 전환 효과
- 현재 기온 표시 (고정 너비 190px)
- 날씨 아이콘 및 설명 (영어)
- 습도 정보 (영어 표시)
- **미세먼지(PM2.5) 정보**: 실시간 대기질 표시 (영어)
- 10분마다 자동 업데이트
- 위치 표시 (국가 및 도시명)
...
- [x] 완전한 영어 지역화 (locale 강제 설정) (v1.3.1)
- [x] 온도 클릭으로 섭씨/화씨 전환 기능 (v1.4.0)
- [x] 회전 애니메이션 효과 (v1.4.0)
- [x] 모든 위젯 라벨 아웃라인 제거 (v1.4.0)
